...
const Progress = (() => {
    ...
    const BADGES = [
        ...
        },
        {
            ...
            emoji: '🎯',
            name:  'In marcia',
            desc:  'Dieci lezioni completate. Non ti fermi più.',
            check: s => totalCompleted(s) >= 10
        },
        {
            id:    'halfway',
            emoji: '🌗',
            name:  'A metà strada',
            desc:  'Venti lezioni. Sei esattamente a metà del percorso completo.',
            check: s => totalCompleted(s) >= 20
        },
        {
            id:    'on_fire',
            emoji: '🔥',
        ...
        },
        {
            ...
            emoji: '🌟',
            name:  'Trecento',
            desc:  '300 XP. La conoscenza si accumula.',
